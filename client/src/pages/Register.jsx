...
function Register() {
  ...
  return (
    <div className="grid grid-cols-3 h-screen">
      <div
        id="regBG"
        className="p-4 col-span-1 flex content-center justify-center "
      >
      ...
      <div className="col-span-2 bg-white p-4 flex flex-col justify-center relative">
        <section id="regInput" className="p-20">
          <h2 className="text-green-700 text-4xl">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="form-control">
                ...
                <input
                  ...
                  className={`input input-${
                    middleInitialValid ? "ghost" : "error"
                  } input-bordered`}
              ...
              <div className="form-control">
                ...
                <div className="input-group">
                  ...
                  <input
                    ...
                    className={`input input-${
                      studentNumberValid ? "ghost" : "error"
              ...
              <div className="form-control ">
                ...
                <div className="input-group">
                  ...
                  <input
                    ...
                    className={`input input-${
                      confirmPasswordValid ? "ghost" : "error"
                    } input-bordered w-full`}
